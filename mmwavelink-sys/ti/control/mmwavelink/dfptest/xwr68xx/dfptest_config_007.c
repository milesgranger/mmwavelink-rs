...
/**
 *  \file xwr68xx\dfptest_config_007.c
 *
...
rlSynthFreqMonConf_t synthFreqNonLiveMonCfg_007[2U] =
{
    {
        .profileIndx = 1,
...
void dfpTestLoadCfg_007(void)
{
    ...
    memcpy((void*)&synthFreqNonLiveMonCfg, (void*)& synthFreqNonLiveMonCfg_007, sizeof(synthFreqNonLiveMonCfg));
