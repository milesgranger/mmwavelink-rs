...
/**
 *  \file xwr68xx\dfptest_config_003.c
 *
...
rlSynthFreqMonConf_t synthFreqNonLiveMonCfg_003[2U] =
{
    {
        .profileIndx = 1,
        .reportMode = MON_REPORT_MODE_PERIODIC_WITHOUT_THRESHOLD_CHECK,
...
void dfpTestLoadCfg_003(void)
{
    ...
    memcpy((void*)&synthFreqNonLiveMonCfg, (void*)& synthFreqNonLiveMonCfg_003, sizeof(synthFreqNonLiveMonCfg));
