...
/**
 *  \file xwr68xx\dfptest_config_008.c
 *
...
rlSynthFreqMonConf_t synthFreqNonLiveMonCfg_008[2U] =
{
    {
        .profileIndx = 1,
        .reportMode = MON_REPORT_MODE_PERIODIC_WITH_THRESHOLD_CHECK,
...
void dfpTestLoadCfg_008(void)
{
    ...
    memcpy((void*)&synthFreqNonLiveMonCfg, (void*)& synthFreqNonLiveMonCfg_008, sizeof(synthFreqNonLiveMonCfg));
