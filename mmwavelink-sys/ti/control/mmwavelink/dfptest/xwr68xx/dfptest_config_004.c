...
/**
 *  \file xwr68xx\dfptest_config_004.c
 *
...
rlSynthFreqMonConf_t synthFreqNonLiveMonCfg_004[2U] =
{
    {
        .profileIndx = 1,
        .reportMode = MON_REPORT_MODE_AT_FAILURE_ONLY,
...
void dfpTestLoadCfg_004(void)
{
    ...
    memcpy((void*)&synthFreqNonLiveMonCfg, (void*)& synthFreqNonLiveMonCfg_004, sizeof(synthFreqNonLiveMonCfg));
