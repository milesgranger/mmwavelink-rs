...
/**
 *  \file xwr68xx\dfptest_config_002.c
 *
...
rlAdvFrameCfg_t advFrameCfg_002 =
{
        ...
        .frameSeq.subFrameCfg[3].subFramePeriodicity = 11000000,
...
rlSynthFreqMonConf_t synthFreqNonLiveMonCfg_002[2U] =
{
    {
        .profileIndx = 1,
        .reportMode = MON_REPORT_MODE_PERIODIC_WITH_THRESHOLD_CHECK,
...
void dfpTestLoadCfg_002(void)
{
    ...
    memcpy((void*)&synthFreqNonLiveMonCfg, (void*)& synthFreqNonLiveMonCfg_002, sizeof(synthFreqNonLiveMonCfg));
