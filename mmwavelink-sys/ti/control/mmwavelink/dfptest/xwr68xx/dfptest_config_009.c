...
/**
 *  \file xwr68xx\dfptest_config_009.c
 *
...
rlAdvFrameCfg_t advFrameCfg_009 =
{
        ...
        .frameSeq.subFrameCfg[3].subFramePeriodicity = 110000000,
...
rlSynthFreqMonConf_t synthFreqNonLiveMonCfg_009[2U] =
{
    {
        .profileIndx = 1,
        .reportMode = MON_REPORT_MODE_PERIODIC_WITH_THRESHOLD_CHECK,
...
void dfpTestLoadCfg_009(void)
{
    ...
    memcpy((void*)&synthFreqNonLiveMonCfg, (void*)& synthFreqNonLiveMonCfg_009, sizeof(synthFreqNonLiveMonCfg));
