...
/**
 *  \file xwr68xx\dfptest_config_010.c
 *
...
dfpTestMiscCfg_t gTestMiscCfg_010 =
{
    ...
    .failStatusFlag[MMWAVELINK_TEST_MON_SYNTH_FREQ_NONLIVE] = 0x0,  //threshold configured to fail
...
rlSynthFreqMonConf_t synthFreqNonLiveMonCfg_010[2U] =
{
    {
        .profileIndx = 1,
        .reportMode = MON_REPORT_MODE_AT_FAILURE_ONLY,
...
void dfpTestLoadCfg_010(void)
{
    ...
    memcpy((void*)&synthFreqNonLiveMonCfg, (void*)& synthFreqNonLiveMonCfg_010, sizeof(synthFreqNonLiveMonCfg));
